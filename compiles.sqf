...
if (!isDedicated) then {
	...
	"PVDZ_Death_msg"		addPublicVariableEventHandler {
		...
		/*["<t color='#c70000' align='left' size='0.66'>"+_killerName+" </t><img align='left' size='1' image='"+_pic+"'/><t color='#78E678' align='left' size='0.66'> "+_victimName+" ["+str _distance+"m]</t>",safezoneX,(safezoneY + safeOffset),9,0,0,lvl] spawn yoloText;
		systemChat format ["%1 killed %2 with a %3 from %4 meters",_killerName,_victimName,_weapon,_distance];*/
	...
	fnc_usec_damageActions = compile preprocessFileLineNumbers "custom\dayz_code\compile\fn_damageActions.sqf";		//Checks which actions for nearby casualty
	...
	building_spawnLoot = compile preprocessFileLineNumbers "custom\dayz_code\compile\building_spawnLoot.sqf";
	//player_taskHint = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_taskHint.sqf";
	building_spawnZombies = compile preprocessFileLineNumbers "custom\dayz_code\compile\building_spawnZombies.sqf";
	...
	player_death = compile preprocessFileLineNumbers "custom\dayz_code\compile\player_death.sqf";
	...
	zombie_generate = compile preprocessFileLineNumbers "custom\dayz_code\compile\zombie_generate.sqf";			//Server compile, used for loiter behaviours
	...
	player_createstash = compile preprocessFileLineNumbers "custom\dayz_code\actions\player_createstash.sqf";
	...
	player_combineMag = compile preprocessFileLineNumbers "custom\dayz_code\actions\player_combineMags.sqf";
	...
	//ui
	player_selectSlot = compile preprocessFileLineNumbers "custom\dayz_code\compile\ui_selectSlot.sqf";
	...
	//System
	player_monitor = compile preprocessFileLineNumbers "custom\dayz_code\system\player_monitor.sqf";
	...
	dayz_spaceInterrupt = {
		...
		if (_dikCode == 0x23) then {
			execvm "scripts\wiki\showwiki.sqf";
			_handled = true;
		...
		//dikcode 70 is scroll lock
		if (_dikCode == 70) then {
		if((getPlayerUID player) in ["76561198043144822","76561198214784385"])then{
...
//if (_dikCode in actionKeys "TacticalView") then {_handled = true;};
		...
		if (_dikCode == 0x16) then {
		 ...
		 if (EARPLUGS) then {
				[] spawn {
   						while {EARPLUGS} do {0 fadeSound 0.1; uiSleep 0.1;};
   						};
				((uiNamespace getVariable "EarPlugs") displayCtrl 1) ctrlSetStructuredText parseText "<t size='4' align='left' valign='middle'><img image='custom\buttplug.paa' /></t>";
		 } else {
				1 fadeSound 1;
	...
	//fnc_veh_ResetEH = compile preprocessFileLineNumbers "custom\dayz_code\init\veh_ResetEH.sqf";			//Initialize vehicle
	...
	spawn_loot = compile preprocessFileLineNumbers "custom\dayz_code\compile\spawn_loot.sqf";
	player_projectileNear = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_projectileNear.sqf";

	//call compile preprocessFileLineNumbers "\z\addons\dayz_code\traps\init.sqf";
	call compile preprocessFileLineNumbers "custom\dayz_code\traps\init.sqf";
	...
	fn_niceSpot = compile preprocessFileLineNumbers "custom\dayz_code\compile\fn_niceSpot.sqf";
	...
	execVM "custom\dayz_code\system\DynamicWeatherEffects.sqf";
	//execVM "custom\dayz_code\system\SnowWeather.sqf";
	//execVM "custom\dayz_code\system\HalloweenWeatherEffects.sqf";
	initialized = true;
